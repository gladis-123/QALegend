...
public class Constants {
	...
	// public static final String SPACE=" ";
	 ...
	 public static final String UPDATEADMIN="AdminUpdate";
	 public static final String UPDATEMSG="AdminUpdate";
	public static final String STOCKTRANSFER = "StockTransfer";
	public static final String KITCHEIDNNUMBER="KitchenTest";
