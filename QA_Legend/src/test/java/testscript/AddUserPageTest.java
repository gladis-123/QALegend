...
import utilties.RandomDataUtility;
...
public class AddUserPageTest extends BaseClass {	
	...
	public void verify_add_user() throws IOException
	 {
		     String username=ExcelUtilityQ.get_String_Data(0, 0, Constants.ADDUSERSPAGE);
			 String password=ExcelUtilityQ.get_Integer_Data(0, 1, Constants.ADDUSERSPAGE);
	...
	public void down_load_created_user_deatils() throws IOException
	{
		 String username=ExcelUtilityQ.get_String_Data(0, 0, Constants.ADDUSERSPAGE);
		 String password=ExcelUtilityQ.get_Integer_Data(0, 1, Constants.ADDUSERSPAGE);
